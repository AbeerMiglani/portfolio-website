...
| `src/components/CascadeDemo.tsx`, `src/lib/cascade.ts` | Ripple card: click a node to knock it out and watch its load spread to neighbours in waves (a simplified illustration, not Motter–Lai) |
